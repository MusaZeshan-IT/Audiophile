...
function BackButton({ marginValueTop, width = 83.33, isPadding = false, display = 'flex' }) {
    ...
    return (
        <>
            {isPadding ? (
                <div className='2xl:px-[135px] xl-custom:px-[130px] xl:px-32 lg-custom:px-12 lg:px-7 px-5 w-full justify-center mt-20 mb-14' style={{ marginTop: marginValueTop, display: display, width: width }}>
