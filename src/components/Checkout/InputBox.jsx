        ...
        <>
            {isDoubled ? (
                <div style={{ width: `${fieldWidth}% ` }}>
                    ...
                    <input required={true} ref={inputRef} onClick={handleClick} id='inputBox' className='w-full border border-[#d0d5dd] h-12 rounded-lg mt-2 px-5 font-bold text-sm tracking-wider' type="text" placeholder={fieldPlaceholder} />
                </div>
            ) : (
