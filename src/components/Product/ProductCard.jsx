...
function ProductCard({ productTitle, productPath, productImage, productTabImage, productDesc, isImageOnLeft, isLabel = false }) {
    return (
        <>
            {isImageOnLeft ?
                <div className='flex lg:flex-row flex-col xl-custom:h-[630px] lg:h-[570px] mb-32 xl-custom:gap-x-28 xl:gap-x-24 lg-custom:gap-x-20 lg:gap-x-16 gap-y-10'>
                    <div className='lg:block sm:hidden xl-custom:w-[52%] lg:w-[55%] w-full rounded-lg'>
                    ...
                    <div className='xl-custom:w-[48%] lg:w-[45%] w-full flex flex-col lg:items-start items-center justify-center'>
                        {isLabel ?
                ...
                <div className='flex lg:flex-row flex-col-reverse lg:h-[570px] mb-32 xl-custom:gap-x-28 xl:gap-x-24 lg-custom:gap-x-20 lg:gap-x-16 gap-y-10'>
                    ...
                    <div className='lg:flex sm:hidden xl-custom:w-[52%] lg:w-[55%] w-full rounded-lg  justify-end'>
